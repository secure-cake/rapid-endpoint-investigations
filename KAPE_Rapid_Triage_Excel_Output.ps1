...
(get-childitem -Directory $triage_data_directory).name | ForEach-Object {
    ...
    get-content "$kape_destination_directory\$_-mft-filelisting\FileSystem\*FileListing.csv" | ConvertFrom-Csv | Where-Object {($_.Extension -eq ".exe") -or ($_.Extension -eq ".zip") -or ($_.Extension -eq ".ps1") -or ($_.Extension -eq ".js") -or ($_.Extension -eq ".dll")} | Export-Csv $kape_destination_directory\$_'-mft_filelisting_executable_files.csv' -NoTypeInformation
