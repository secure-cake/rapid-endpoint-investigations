...
(get-childitem -Directory $triage_data_directory).name | ForEach-Object {
    ...
    #Perofrms $MFT file listing analysis for C-D-E drives, output to mft-filelisting sub-directory ...not rolled up into Excel
    ...
    get-content "$kape_destination_directory\$_-c-drive-mft-filelisting\FileSystem\*FileListing.csv" | ConvertFrom-Csv | Where-Object {($_.Extension -eq ".exe") -or ($_.Extension -eq ".zip") -or ($_.Extension -eq ".ps1") -or ($_.Extension -eq ".js") -or ($_.Extension -eq ".dll") -or ($_.Extension -eq ".vbs") -or ($_.Extension -eq ".cmd") -or ($_.Extension -eq ".bat") -or ($_.Extension -eq ".xml") -or ($_.Extension -eq ".7z") -or ($_.Extension -eq ".rar")} | Export-Csv $kape_destination_directory\$_'-c-drive-mft_filelisting_executable_files.csv' -NoTypeInformation
    Invoke-Kape -msource $triage_data_directory\$_\uploads\ntfs\%5C%5C.%5CD%3A -mdest "$kape_destination_directory\$_-d-drive-mft-filelisting" -Module 'MFTECmd_$MFT_FileListing' -mvars csv
    get-content "$kape_destination_directory\$_-d-drive-mft-filelisting\FileSystem\*FileListing.csv" | ConvertFrom-Csv | Where-Object {($_.Extension -eq ".exe") -or ($_.Extension -eq ".zip") -or ($_.Extension -eq ".ps1") -or ($_.Extension -eq ".js") -or ($_.Extension -eq ".dll") -or ($_.Extension -eq ".vbs") -or ($_.Extension -eq ".cmd") -or ($_.Extension -eq ".bat") -or ($_.Extension -eq ".xml") -or ($_.Extension -eq ".7z") -or ($_.Extension -eq ".rar")} | Export-Csv $kape_destination_directory\$_'-d-drive-mft_filelisting_executable_files.csv' -NoTypeInformation
    Invoke-Kape -msource $triage_data_directory\$_\uploads\ntfs\%5C%5C.%5CE%3A -mdest "$kape_destination_directory\$_-e-drive-mft-filelisting" -Module 'MFTECmd_$MFT_FileListing' -mvars csv
    get-content "$kape_destination_directory\$_-e-drive-mft-filelisting\FileSystem\*FileListing.csv" | ConvertFrom-Csv | Where-Object {($_.Extension -eq ".exe") -or ($_.Extension -eq ".zip") -or ($_.Extension -eq ".ps1") -or ($_.Extension -eq ".js") -or ($_.Extension -eq ".dll") -or ($_.Extension -eq ".vbs") -or ($_.Extension -eq ".cmd") -or ($_.Extension -eq ".bat") -or ($_.Extension -eq ".xml") -or ($_.Extension -eq ".7z") -or ($_.Extension -eq ".rar")} | Export-Csv $kape_destination_directory\$_'-e-drive-mft_filelisting_executable_files.csv' -NoTypeInformation
